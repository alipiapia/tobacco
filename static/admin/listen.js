...
define(['jquery', 'admin.plugs'], function () {
    ...
    this.$body.on('click', '[data-file]', function () {
        ...
        var path = $(this).attr('data-path') || 'picture'; // 图片路径 cms/article
        /*todo 独立后台域名设置*/
        var url = window.ROOT_URL + '/admin/plugs/upfile.html?mode=' + method + '&uptype=' + uptype + '&type=' + type + '&field=' + field + '&path=' + path;
        // var url = window.ROOT_URL + '/plugs/upfile.html?mode=' + method + '&uptype=' + uptype + '&type=' + type + '&field=' + field + '&path=' + path;
    ...
    this.$body.on('click', '[data-icon]', function () {
        ...
        var url = window.ROOT_URL + '/admin/plugs/icon.html?field=' + field;
        // var url = window.ROOT_URL + '/index.php/admin/plugs/icon.html?field=' + field;
        // var url = window.ROOT_URL + '/plugs/icon.html?field=' + field;
