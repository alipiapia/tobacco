...
CREATE TABLE `document` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='文件资料表';
...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('10001', 'shishang', '111111', '史上0001', '1', '415', 'http://1.ynncp.com/static/upload/avatar/10001/20190111/1cf77b42d5551dfe244143279c468428.jpg', null, '', '18347944063', '', '338', '2019-02-27 12:01:31', '0', '0', null, '0000-00-00 00:00:00');
INSERT INTO `member` VALUES ('10002', 'pengpu', '111111', '彭普0001', '2', '416', 'http://1.ynncp.com/static/upload/avatar/10002/20190121/aa45581dde0914215d0013387377d686.jpg', null, '', '18208702258', '', '612', '2019-02-27 13:37:57', '0', '0', null, '0000-00-00 00:00:00');
INSERT INTO `member` VALUES ('10003', 'test0001', '111111', '监测站0001', '1', '415', 'http://1.ynncp.com/static/upload/avatar/10003/20190220/48a182ecb8833d5b32185ecc11bf4ac8.jpg', null, '', '15398392715', '', '11', '2019-02-27 12:51:00', '0', '0', null, '0000-00-00 00:00:00');
INSERT INTO `member` VALUES ('10004', 'wangxinhai', '111111', '王新海0001', '2', '0', 'http://1.ynncp.com/static/upload/avatar/10004/20190220/84d04920ccec82de982fbc14ecef1803.png', null, '', '18214552124', '', '84', '2019-02-27 15:43:25', '0', '0', null, '0000-00-00 00:00:00');
...
INSERT INTO `member` VALUES ('10008', 'tiantian', '123456', '田tian', '2', '0', null, null, '', '13759437459', '', '11', '2019-02-27 13:39:15', '0', '0', null, '0000-00-00 00:00:00');
INSERT INTO `member` VALUES ('10009', 'tt', '123456', 't', '1', '415', 'http://1.ynncp.com/static/upload/avatar/10009/20190222/8063d4ba478cc426f01f5f8a7e662488.jpg', null, '', '18987497629', '', '14', '2019-02-27 11:40:42', '0', '0', null, '0000-00-00 00:00:00');
...
CREATE TABLE `member_collection` (
  ...
  `create_at` int(11) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户收藏表';
...
CREATE TABLE `member_message` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户消息表';
...
-- Records of sms_log
-- ----------------------------
INSERT INTO `sms_log` VALUES ('1', '18347944063', '384647', '1551240082');
INSERT INTO `sms_log` VALUES ('2', '15398392715', '252177', '1551243035');
INSERT INTO `sms_log` VALUES ('3', '18214552124', '027071', '1551253399');
INSERT INTO `sms_log` VALUES ('4', '18208702258', '626550', '1551245809');
INSERT INTO `sms_log` VALUES ('5', '13759437459', '948201', '1551245943');
INSERT INTO `sms_log` VALUES ('6', '18987497629', '561357', '1551238832');
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=138 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统操作日志表';
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', null, '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', '23071', '2019-02-27 10:45:35', '0', '1,2', '0', null, '2015-11-13 15:14:22');
