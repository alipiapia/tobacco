...
INSERT INTO `machine` VALUES ('28', '27号机', '5', '1,28', '/^06[1-3]{1}27$/', '/^06[1-3]{1}27(0[1-9]|1[0-2]){1}$/', '{\"cj\":\"66\",\"bzjx\":\"54\",\"jyjx\":\"73\",\"ldtwz\":\"1\",\"ldtxz\":\"3\",\"thkgfs\":\"4\",\"jzjlx\":\"8\",\"thcbdb\":\"11\",\"thbjlx\":\"12\",\"tbjwz\":\"13\",\"bjhy\":\"15\",\"hldtwz\":\"18\",\"hldtxz\":\"21\",\"hldtzlfs\":\"23\",\"hlcjdxz\":\"25\",\"lbzbzfs\":\"28\",\"lbzyybzlfs\":\"31\",\"jzjlx2\":\"38\",\"hywfw\":\"40\",\"hfwwz\":\"43\",\"xhbjhy\":\"49\",\"yzpl\":\"64\"}', '27', '1544412963', '1551274135', '0', '0');
...
INSERT INTO `machine` VALUES ('51', '手工包装', '12', '4,12,27,31,35', '/^99999$/', '/^9999999$/', '', '0', '1552903025', '1553088221', '0', '0');
...
INSERT INTO `member` VALUES ('10002', 'pengpu', '111111', '彭普0001', '2', '416', 'http://1.ynncp.com/static/upload/avatar/10002/20190121/aa45581dde0914215d0013387377d686.jpg', null, '', '18208702258', '', '641', '2019-05-27 14:37:43', '0', '0', null, '0000-00-00 00:00:00');
INSERT INTO `member` VALUES ('10003', 'test0001', '111111', '彭普0002', '1', '415', 'http://1.ynncp.com/static/upload/avatar/10003/20190220/48a182ecb8833d5b32185ecc11bf4ac8.jpg', null, '', '19187149527', '', '21', '2019-04-10 12:12:21', '0', '0', null, '0000-00-00 00:00:00');
...
INSERT INTO `member` VALUES ('10016', 'changsheng', '111111', '常晟', '2', '415', null, null, '', '13529306312', '', '5', '2019-04-18 21:21:43', '0', '0', null, '0000-00-00 00:00:00');
...
INSERT INTO `member` VALUES ('10018', 'yyh2019', '111111', '杨云会', '1', '415', null, null, '', '15825282559', '', '2', '2019-06-04 14:23:35', '0', '0', null, '0000-00-00 00:00:00');
...
CREATE TABLE `member_collection` (
  ...
  `create_at` int(11) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户收藏表';
...
INSERT INTO `sms_log` VALUES ('4', '18208702258', '939353', '1558939049');
...
INSERT INTO `sms_log` VALUES ('12', '18987272926', '873063', '1556067749');
...
INSERT INTO `sms_log` VALUES ('18', '13529306312', '412362', '1555593606');
INSERT INTO `sms_log` VALUES ('19', '19187149527', '178710', '1554869495');
...
INSERT INTO `sms_log` VALUES ('25', '15825282559', '357617', '1559629377');
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=195 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统操作日志表';
...
INSERT INTO `system_log` VALUES ('193', '116.249.206.235', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-06-05 15:38:36');
INSERT INTO `system_log` VALUES ('194', '116.249.206.235', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-06-06 08:50:05');
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', null, '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', '23125', '2019-06-06 08:50:05', '0', '1,2', '0', null, '2015-11-13 15:14:22');
