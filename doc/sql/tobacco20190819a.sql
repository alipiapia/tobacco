...
INSERT INTO `member` VALUES ('10012', '13608808066', '111111', '肖燕', '1', '415', null, null, '', '13608808066', '', '5', '2019-05-05 12:26:30', '0', '0', null, '0000-00-00 00:00:00');
...
CREATE TABLE `product` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=135 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='产品表';
...
CREATE TABLE `product_item` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=485 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='属性值表';
...
INSERT INTO `sms_log` VALUES ('23', '13608808066', '426485', '1557030365');
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=215 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统操作日志表';
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', null, '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', '23145', '2019-08-19 09:37:46', '0', '1,2', '0', null, '2015-11-13 15:14:22');
