...
INSERT INTO `machine` VALUES ('257', '3#', '9', '7', '', '/^C[0-9]{1}(0[1-9]|1[0-2]){1}03$/', '/^C[0-9]{1}(0[1-9]|1[0-2]){1}03$/', '{\"bzjx\":\"80\"}', '0', '1568197475', '1568862338', '0', '0');
...
INSERT INTO `machine` VALUES ('266', 'Y1', '10', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}1$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}(0|1)$/', '{\"bzjx\":\"62\"}', '0', '1568774205', '1568774680', '0', '0');
INSERT INTO `machine` VALUES ('267', 'Y2', '10', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}2$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}(2|9)$/', '{\"bzjx\":\"62\"}', '0', '1568774698', null, '0', '0');
INSERT INTO `machine` VALUES ('268', 'Y3', '17', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}3$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}3$/', '{\"bzjx\":\"81\"}', '0', '1568775007', null, '0', '0');
INSERT INTO `machine` VALUES ('269', 'Y4', '17', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}4$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}4$/', '{\"bzjx\":\"81\"}', '0', '1568775007', null, '0', '0');
INSERT INTO `machine` VALUES ('270', 'Y5', '17', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}5$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}5$/', '{\"bzjx\":\"81\"}', '0', '1568775007', null, '0', '0');
INSERT INTO `machine` VALUES ('271', 'Y6', '17', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}6$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}6$/', '{\"bzjx\":\"81\"}', '0', '1568775007', null, '0', '0');
INSERT INTO `machine` VALUES ('272', 'Y7', '17', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}7$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}7$/', '{\"bzjx\":\"81\"}', '0', '1568775007', null, '0', '0');
INSERT INTO `machine` VALUES ('273', 'Y8', '17', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}8$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}8$/', '{\"bzjx\":\"81\"}', '0', '1568775007', null, '0', '0');
INSERT INTO `machine` VALUES ('274', 'R1', '9', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}1$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}1$/', '{\"bzjx\":\"80\"}', '0', '1568775221', null, '0', '0');
INSERT INTO `machine` VALUES ('275', 'R2', '9', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}2$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}2$/', '{\"bzjx\":\"80\"}', '0', '1568775221', null, '0', '0');
INSERT INTO `machine` VALUES ('276', 'R3', '9', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}3$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}3$/', '{\"bzjx\":\"80\"}', '0', '1568775221', null, '0', '0');
INSERT INTO `machine` VALUES ('277', 'R4', '9', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}4$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}4$/', '{\"bzjx\":\"80\"}', '0', '1568775221', null, '0', '0');
INSERT INTO `machine` VALUES ('278', 'R5', '9', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}5$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}5$/', '{\"bzjx\":\"80\"}', '0', '1568775221', null, '0', '0');
INSERT INTO `machine` VALUES ('279', 'R6', '13', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}6$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}6$/', '{\"bzjx\":\"77\"}', '0', '1568775221', '1568775422', '0', '0');
INSERT INTO `machine` VALUES ('280', 'R7', '13', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}7$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}7$/', '{\"bzjx\":\"77\"}', '0', '1568775221', '1568775443', '0', '0');
INSERT INTO `machine` VALUES ('281', 'R8', '13', '6', '', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}8$/', '/^D[0-9]{1}(0[1-9]|1[0-2]){1}[1-3]{1}8$/', '{\"bzjx\":\"77\"}', '0', '1568775221', '1568775454', '0', '0');
INSERT INTO `machine` VALUES ('282', '硬1#', '16', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)1$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)1$/', '{\"bzjx\":\"85\"}', '0', '1568801743', null, '0', '0');
INSERT INTO `machine` VALUES ('283', '硬2#', '16', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)2$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)2$/', '{\"bzjx\":\"85\"}', '0', '1568801743', null, '0', '0');
INSERT INTO `machine` VALUES ('284', '硬3#', '16', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)3$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)3$/', '{\"bzjx\":\"85\"}', '0', '1568801743', null, '0', '0');
INSERT INTO `machine` VALUES ('285', '硬4#', '16', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)4$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)4$/', '{\"bzjx\":\"85\"}', '0', '1568801743', null, '0', '0');
INSERT INTO `machine` VALUES ('286', '硬5#', '16', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)5$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)5$/', '{\"bzjx\":\"85\"}', '0', '1568801743', null, '0', '0');
INSERT INTO `machine` VALUES ('287', '硬6#', '16', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)6$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)6$/', '{\"bzjx\":\"85\"}', '0', '1568801743', null, '0', '0');
INSERT INTO `machine` VALUES ('288', '硬7#', '16', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)7$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)7$/', '{\"bzjx\":\"85\"}', '0', '1568801743', null, '0', '0');
INSERT INTO `machine` VALUES ('289', '硬8#', '16', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)8$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)8$/', '{\"bzjx\":\"85\"}', '0', '1568801743', null, '0', '0');
INSERT INTO `machine` VALUES ('290', '硬9#', '5', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)9$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)9$/', '{\"bzjx\":\"79\"}', '0', '1568801743', '1568802059', '0', '0');
INSERT INTO `machine` VALUES ('291', '硬10#', '5', '5', '', '/^$/', '/^$/', '{\"bzjx\":\"79\"}', '0', '1568801743', null, '0', '1');
INSERT INTO `machine` VALUES ('292', '软1#', '9', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)1$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)1$/', '{\"bzjx\":\"80\"}', '0', '1568801743', '1568802154', '0', '0');
INSERT INTO `machine` VALUES ('293', '软2#', '9', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)2$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)2$/', '{\"bzjx\":\"80\"}', '0', '1568801743', '1568802154', '0', '0');
INSERT INTO `machine` VALUES ('294', '软3#', '9', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)3$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)3$/', '{\"bzjx\":\"80\"}', '0', '1568801743', '1568802154', '0', '0');
INSERT INTO `machine` VALUES ('295', '软4#', '9', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)4$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)4$/', '{\"bzjx\":\"80\"}', '0', '1568801743', '1568802154', '0', '0');
INSERT INTO `machine` VALUES ('296', '软5#', '9', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)5$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)5$/', '{\"bzjx\":\"80\"}', '0', '1568801743', '1568802154', '0', '0');
INSERT INTO `machine` VALUES ('297', '软6#', '13', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)6$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)6$/', '{\"bzjx\":\"77\"}', '0', '1568801743', '1568802433', '0', '0');
INSERT INTO `machine` VALUES ('298', '软7#', '13', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)7$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)7$/', '{\"bzjx\":\"77\"}', '0', '1568801743', '1568802154', '0', '0');
INSERT INTO `machine` VALUES ('299', '软8#', '13', '5', '', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)8$/', '/^P[0-9]{1}(0[1-9]|1[0-2]){1}(0|3|6)8$/', '{\"bzjx\":\"77\"}', '0', '1568801743', '1568802154', '0', '0');
...
INSERT INTO `member` VALUES ('10003', 'test0001', '111111', '彭普0002', '1', '415', 'http://1.ynncp.com/static/upload/avatar/10003/20190220/48a182ecb8833d5b32185ecc11bf4ac8.jpg', null, '', '19187149527', '', '24', '2019-09-18 14:57:14', '0', '0', null, '0000-00-00 00:00:00');
...
INSERT INTO `member` VALUES ('10019', 'zuo', '111111', '左艳', '1', '4479', null, null, '', '15288201702', '', '6', '2019-08-12 16:11:55', '0', '0', null, '0000-00-00 00:00:00');
...
INSERT INTO `sms_log` VALUES ('19', '19187149527', '272260', '1568789816');
...
INSERT INTO `sms_log` VALUES ('26', '15288201702', '328198', '1568789968');
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=238 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统操作日志表';
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', null, '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', '23168', '2019-09-19 09:28:08', '0', '1,2', '0', null, '2015-11-13 15:14:22');
