...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('10001', 'shishang', '111111', '史上0001', '1', '37', 'http://1.ynncp.com/static/upload/avatar/10001/20190111/1cf77b42d5551dfe244143279c468428.jpg', null, '', '18347944063', '', '320', '2019-01-23 13:40:27', '0', '0', null, '0000-00-00 00:00:00');
INSERT INTO `member` VALUES ('10002', 'pengpu', '111111', '彭普0001', '1', '38', 'http://1.ynncp.com/static/upload/avatar/10002/20190121/aa45581dde0914215d0013387377d686.jpg', null, '', '18208702258', '', '514', '2019-01-28 17:37:13', '0', '0', null, '0000-00-00 00:00:00');
INSERT INTO `member` VALUES ('10003', 'test0001', '111111', '监测站0001', '1', '41', null, null, '', '15888888888', '', '4', '2019-01-19 20:28:41', '0', '0', null, '0000-00-00 00:00:00');
...
CREATE TABLE `member_collection` (
  ...
  `create_at` int(11) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户收藏表';
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=115 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统操作日志表';
...
INSERT INTO `system_menu` VALUES ('3', '10', '系统参数', '', 'fa fa-modx', 'admin/config/index', '', '_self', '3', '1', '10000', '2018-01-19 15:27:57');
...
INSERT INTO `system_menu` VALUES ('9', '10', '文件存储', '', 'fa fa-stop-circle', 'admin/config/file', '', '_self', '4', '1', '0', '2018-01-25 10:54:28');
...
INSERT INTO `system_menu` VALUES ('50', '10', '关于我们', '', 'fa fa-id-card-o', 'admin/config/aboutus', '', '_self', '5', '1', '0', '2019-01-24 16:36:07');
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', null, '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', '23049', '2019-01-28 16:51:24', '0', '1,2', '0', null, '2015-11-13 15:14:22');
