...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='机器表';

-- ----------------------------
-- Records of machine
-- ----------------------------
INSERT INTO `machine` VALUES ('1', 'F', '0', '1544082253', '1545211899', '0', '0', '{\"jx\":\"FX\",\"cj\":\"66\",\"ldtwz\":\"1\",\"ldtxz\":\"3\",\"thkgfs\":\"4\",\"jzjlx\":\"7\",\"thcbdb\":\"11\",\"thbjlx\":\"12\",\"tbjwz\":\"13\",\"bjhy\":\"15\",\"hldtwz\":\"18\",\"hldtxz\":\"20\",\"hldtzlfs\":\"23\",\"hlcjdxz\":\"24\",\"lbzbzfs\":\"28\",\"lbzyybzlfs\":\"30\",\"jzjlx2\":\"38\",\"hywfw\":\"40\",\"hfwwz\":\"42\",\"xhbjhy\":\"48\",\"bzjx\":\"53\",\"yzpl\":\"63\"}');
...
CREATE TABLE `machine_item` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='属性值表';
...
CREATE TABLE `machine_spec` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='规格表';
...
CREATE TABLE `product_item` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=145 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='属性值表';
...
CREATE TABLE `product_spec` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='规格表';
...
INSERT INTO `product_spec` VALUES ('29', '产品logo', 'cptp', '产品logo', '5', '30', '1544508714', null, '0', '1');
...
) ENGINE=InnoDB AUTO_INCREMENT=153 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统角色与节点绑定';
...
-- ----------------------------
INSERT INTO `system_config` VALUES ('1', 'app_name', '卷烟产品鉴别平台');
INSERT INTO `system_config` VALUES ('2', 'site_name', '卷烟产品鉴别平台');
INSERT INTO `system_config` VALUES ('3', 'app_version', 'R');
INSERT INTO `system_config` VALUES ('4', 'site_copy', '©版权所有 2014-2018 云南中烟工业');
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统操作日志表';
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', '22997', '2018-12-20 10:45:57', '1', '1', '0', null, '2015-11-13 15:14:22');
