...
INSERT INTO `member` VALUES ('10002', 'pengpu', '111111', '彭普0001', '1', '38', 'http://1.ynncp.com/static/upload/avatar/10002/20190121/aa45581dde0914215d0013387377d686.jpg', null, '', '18208702258', '', '460', '2019-01-24 13:58:54', '0', '0', null, '0000-00-00 00:00:00');
...
CREATE TABLE `member_collection` (
  ...
  `create_at` int(11) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户收藏表';
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=102 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统操作日志表';
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', null, '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', '23045', '2019-01-24 09:47:18', '0', '1,2', '0', null, '2015-11-13 15:14:22');
