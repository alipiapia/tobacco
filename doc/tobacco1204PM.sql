...
CREATE TABLE `product`  (
  ...
  `desc` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '描述',
  `title_id` int(11) NULL DEFAULT NULL COMMENT '名称id',
  `create_at` int(11) NULL DEFAULT NULL COMMENT '创建时间',
  `update_at` int(11) NULL DEFAULT NULL COMMENT '更新时间',
  `is_deleted` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '删除状态(1:删除,0:未删)',
  `status` tinyint(1) NULL DEFAULT 0 COMMENT '状态 0正常 1禁用 默认0',
...
CREATE TABLE `product_item`  (
  ...
  `status` tinyint(1) NULL DEFAULT 0 COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '属性值表' ROW_FORMAT = Compact;
...
CREATE TABLE `product_spec`  (
  ...
  `status` tinyint(1) NULL DEFAULT 0 COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '属性表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of product_spec
-- ----------------------------
INSERT INTO `product_spec` VALUES (1, '产品名称', 0, '产品名称1', 1, 1543830101, 1543830101, 0, 0);
INSERT INTO `product_spec` VALUES (2, '条形码', 0, '条条形码', 2, 1543823339, 1543823339, 0, 0);
INSERT INTO `product_spec` VALUES (3, '盒条形码', 0, '盒条形码', 0, 1543823318, NULL, 0, 0);
INSERT INTO `product_spec` VALUES (4, '拉带材质文字图案及其他', 1, '拉带材质文字图案及其他', 3, 1543823381, NULL, 0, 0);
...
CREATE TABLE `system_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统操作日志表' ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `system_user` VALUES (10000, 'admin', '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', 22979, '2018-12-04 08:32:16', 1, '1', 0, NULL, '2015-11-13 15:14:22');
