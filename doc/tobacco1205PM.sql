...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (1, NULL, '', 0, 1544004896, 1544004896, 0, 0, 'YTo2OntzOjQ6ImNwbWMiO3M6Njoi5Y2w6LGhIjtzOjQ6InR0eG0iO3M6MzoiMTIzIjtzOjQ6Imh0eG0iO3M6MzoiNDU2IjtzOjQ6ImxkY3oiO3M6MToiNyI7czo0OiJkc2J6IjtzOjI6IjExIjtzOjI6Im1zIjtzOjE1OiI8cD7ljbDosaE8L3A+DQoiO30=');
INSERT INTO `product` VALUES (2, NULL, '', 0, 1544003152, 1544003152, 0, 0, '');
...
CREATE TABLE `product_item`  (
  ...
  `status` tinyint(1) NULL DEFAULT 0 COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '属性值表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of product_item
-- ----------------------------
INSERT INTO `product_item` VALUES (1, '云烟（紫）', 1, '云烟（紫）', 0, 1543890293, NULL, 0, 0);
INSERT INTO `product_item` VALUES (2, '云烟（软珍品）', 1, '云烟（软珍品）', 0, 1543892499, NULL, 0, 0);
INSERT INTO `product_item` VALUES (3, '云烟（印象）', 1, '云烟（印象）', 0, 1543892516, NULL, 0, 0);
...
CREATE TABLE `product_spec`  (
  ...
  `status` tinyint(1) NULL DEFAULT 0 COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '属性表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of product_spec
-- ----------------------------
INSERT INTO `product_spec` VALUES (1, '产品名称', 'cpmc', '产品名称1', 1, 1, 1543980390, 1543980390, 0, 0);
...
INSERT INTO `product_spec` VALUES (4, '拉带材质文字图案及其他', 'ldcz', '拉带材质文字图案及其他', 3, 4, 1544004729, 1544004729, 0, 0);
INSERT INTO `product_spec` VALUES (5, '条商标纸材质', 'dsbz', '条商标纸材质', 3, 5, 1544004736, 1544004736, 0, 0);
INSERT INTO `product_spec` VALUES (6, '描述', 'ms', '', 4, 99, 1544004766, NULL, 0, 0);
...
CREATE TABLE `system_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统操作日志表' ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `system_user` VALUES (10000, 'admin', '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', 22980, '2018-12-05 08:49:50', 1, '1', 0, NULL, '2015-11-13 15:14:22');
