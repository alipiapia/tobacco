...
INSERT INTO `member` VALUES (10006, 'pp0001', '111111', '1234589', 2, NULL, NULL, '', '18208885556', '', 3, '2018-12-29 15:41:52', 0, 0, NULL, '0000-00-00 00:00:00');
...
CREATE TABLE `member_collection`  (
  ...
  `create_at` int(11) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户收藏表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of member_collection
-- ----------------------------
INSERT INTO `member_collection` VALUES (1, 1, 1, 1544082253);
INSERT INTO `member_collection` VALUES (2, 1, 3, NULL);
...
CREATE TABLE `system_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统操作日志表' ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `system_user` VALUES (10000, 'admin', NULL, '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', 23008, '2019-01-02 08:34:10', 0, '1', 0, NULL, '2015-11-13 15:14:22');
