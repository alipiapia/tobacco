...
CREATE TABLE `factory` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='生产部门/厂家/公司表';

-- ----------------------------
-- Records of factory
-- ----------------------------
INSERT INTO `factory` VALUES ('1', '昆明卷烟厂', '', '昆明卷烟厂', '1', '1566120873', '1566120918', '0', '0');
INSERT INTO `factory` VALUES ('2', '曲靖卷烟厂', '', '曲靖卷烟厂', '100', '1566120946', null, '0', '0');
INSERT INTO `factory` VALUES ('3', '红河卷烟厂', '', '红河卷烟厂', '100', '1566120962', null, '0', '0');
INSERT INTO `factory` VALUES ('4', '会泽卷烟厂', '', '会泽卷烟厂', '100', '1566120987', null, '0', '0');
...
CREATE TABLE `machine` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='机台表';
...
INSERT INTO `machine` VALUES ('51', '手工包装', '12', '1', '4,12,27,31,35', '/^99999$/', '/^9999999$/', '', '0', '1552903025', '1553088221', '0', '0');
...
CREATE TABLE `product` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=144 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='产品表';
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=223 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统操作日志表';
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', null, '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', '23153', '2019-09-06 09:02:26', '0', '1,2', '0', null, '2015-11-13 15:14:22');
...
CREATE TABLE `type` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='机型表';
...
INSERT INTO `type` VALUES ('12', '手工包装', '', '手工包装', '0', '1552902995', null, '0', '0');
