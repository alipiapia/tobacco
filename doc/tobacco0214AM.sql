...
-- Records of document
-- ----------------------------
INSERT INTO `document` VALUES ('1', '通知1', 'http://1.ynncp.com/static/upload/d86e96f6f321ddeb/81f8731ebc7e5b14.xls', null, '通知1', '内容1', null, '2', '1', '0', '1544082253', '1548666438', '0', '0');
INSERT INTO `document` VALUES ('2', '通知2', 'http://1.ynncp.com/static/upload/04372c3d53368bd7/d974b329a47067f2.docx', null, '通知2', '红河2', null, '2', '1,2,3', '0', '1545641708', '1548667957', '0', '0');
INSERT INTO `document` VALUES ('3', '管理办法', 'http://1.ynncp.com/static/upload/9da837a7ef47b836/e176d2153d687870.png', 'png', null, '通知3', null, '1', '1,2', '0', '1548063225', '1548669503', '0', '0');
INSERT INTO `document` VALUES ('4', '通知4', 'http://1.ynncp.com/static/upload/0e45ffb3dc1189d2/b0c9d163e4ef0c1e.xlsx', null, null, '通知4', '10000', '1', '2', '0', '1548063484', '1548667602', '0', '0');
INSERT INTO `document` VALUES ('5', '666', 'http://1.ynncp.com/static/upload/83d62ea2784edc4e/ddde5ef113f34674.pdf', 'pdf', null, null, '10000', '1', '1', '0', '1548121028', '1548669509', '0', '0');
...
INSERT INTO `member` VALUES ('10002', 'pengpu', '111111', '彭普0001', '1', '416', 'http://1.ynncp.com/static/upload/avatar/10002/20190121/aa45581dde0914215d0013387377d686.jpg', null, '', '18208702258', '', '522', '2019-02-12 14:02:47', '0', '0', null, '0000-00-00 00:00:00');
...
CREATE TABLE `member_collection` (
  ...
  `create_at` int(11) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户收藏表';
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=124 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统操作日志表';
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', null, '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', '23057', '2019-02-14 10:55:19', '0', '1,2', '0', null, '2015-11-13 15:14:22');
