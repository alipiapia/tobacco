...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='品牌表';
...
CREATE TABLE `machine` (
  ...
  `pattern` varchar(255) DEFAULT NULL COMMENT '钢印号匹配规则',
...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('1', 'user1', '111111', 'dggd', '1', null, '22222222', '', '18208885555', '', '1', '2018-12-21 13:57:31', '0', '0', null, '2015-11-13 15:14:22');
INSERT INTO `member` VALUES ('6', 'pp0001', '111111', '1234589', '2', null, null, '', '18208885556', '', '3', '2018-12-29 15:41:52', '0', '0', null, '0000-00-00 00:00:00');
INSERT INTO `member` VALUES ('7', 'pp0002', '111111', '5678', '2', null, null, '', '18208885557', '', '0', null, '0', '0', null, '0000-00-00 00:00:00');
INSERT INTO `member` VALUES ('8', 'pp0003', '111111', 'mmm1', null, null, null, '', '18208885558', '', '0', null, '0', '0', null, '0000-00-00 00:00:00');
...
CREATE TABLE `member_collection` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `mid` int(11) unsigned DEFAULT '0' COMMENT '收藏用户',
  `pid` int(11) DEFAULT NULL COMMENT '产品',
  `create_at` int(11) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户收藏表';
...
CREATE TABLE `member_message` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `mid` int(11) unsigned DEFAULT '0' COMMENT '数据排序',
  `title` varchar(255) DEFAULT NULL COMMENT '名称',
  `desc` varchar(255) DEFAULT NULL COMMENT '描述',
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '状态 0正常 1禁用 默认0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户消息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统参数配置';
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统操作日志表';
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', null, '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', '23007', '2018-12-29 08:35:42', '0', '1', '0', null, '2015-11-13 15:14:22');
