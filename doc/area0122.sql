...
CREATE TABLE `area`  (
  ...
  `area_region` varchar(3) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '大区名称',
  `area_open` tinyint(2) NOT NULL DEFAULT 0 COMMENT '地区是否开启',
  PRIMARY KEY (`area_id`) USING BTREE,
  INDEX `area_parent_id`(`area_parent_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45057 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'andy - 地区表' ROW_FORMAT = Compact;
