...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('10001', 'shishang', '111111', '史上0001', '1', '415', 'http://1.ynncp.com/static/upload/avatar/10001/20190111/1cf77b42d5551dfe244143279c468428.jpg', null, '', '18347944063', '', '320', '2019-01-23 13:40:27', '0', '0', null, '0000-00-00 00:00:00');
INSERT INTO `member` VALUES ('10002', 'pengpu', '111111', '彭普0001', '1', '416', 'http://1.ynncp.com/static/upload/avatar/10002/20190121/aa45581dde0914215d0013387377d686.jpg', null, '', '18208702258', '', '532', '2019-02-18 10:22:15', '0', '0', null, '0000-00-00 00:00:00');
INSERT INTO `member` VALUES ('10003', 'test0001', '111111', '监测站0001', '1', '415', null, null, '', '15888888888', '', '4', '2019-01-19 20:28:41', '0', '0', null, '0000-00-00 00:00:00');
...
CREATE TABLE `member_collection` (
  ...
  `create_at` int(11) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户收藏表';
...
-- Records of problem
-- ----------------------------
INSERT INTO `problem` VALUES ('1', '通知1', '通知1', '内容1', null, '1', '0', '1544082253', '1548234745', '0', '0');
INSERT INTO `problem` VALUES ('2', '通知2', '通知2', '红河2', null, '1,2', '0', '1545641708', '1548235022', '0', '0');
INSERT INTO `problem` VALUES ('3', '你想知道常见的烟草真伪鉴别里面都有哪些常识吗？', null, '1、你想知道常见的烟草真伪鉴别里面都有哪些常识吗？\r\n2、你想知道常见的烟草真伪鉴别里面都有哪些常识吗？\r\n3、你想知道常见的烟草真伪鉴别里面都有哪些常识吗？\r\n4、你想知道常见的烟草真伪鉴别里面都有哪些常识吗？', null, '1,2', '0', '1548063225', '1548233321', '0', '0');
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统操作日志表';
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', null, '0192023a7bbd73250516f069df18b500', '22222222', '', '', '', '23059', '2019-02-18 09:49:51', '0', '1,2', '0', null, '2015-11-13 15:14:22');
